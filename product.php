            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="row">
                        ...
                        ?>
<div>
<a href="#" class="btn primary-btn" id="tryOnBtn" style="margin-top: 20px;margin-bottom:20px">Try-On</a>
</div>
...
<script>
    document.getElementById('tryOnBtn').addEventListener('click', function(e) {
        e.preventDefault();
        const productId = "<?php echo isset($_GET['product_id']) ? $_GET['product_id'] : ''; ?>";
        if (productId) {
            const tryOnUrl = `https://8fb060ea2da379f940.gradio.live?cloth=Cloth%20${productId}`;
